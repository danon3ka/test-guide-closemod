const detailsElement = document.querySelector('.my-details'); // или другой селектор для вашего details
if (detailsElement) {
  const observer = new MutationObserver((mutationsList) => {
    mutationsList.forEach(mutation => {
      if (mutation.attributeName === 'open') {
        console.log('Атрибут open изменён. Текущее состояние:', detailsElement.hasAttribute('open'));
      }
    });
  });
...
document.querySelectorAll('details.my-details summary').forEach(summary => {
    summary.addEventListener('click', (e) => {
      // Если требуется, можно использовать stopPropagation, но это может помешать стандартному переключению.
      // e.stopPropagation();
      console.log('Клик по summary, текущий open:', summary.parentElement.hasAttribute('open'));
    });
  });
            ...
            const rules = [
                {
                    ...
                    content: `
                        ...
                        <div>
                            ...
                            <p class="tab-indent">3. Используем комбинации <span class="grey-bg-kbd">Ctrl + F</span> и <span class="grey-bg-kbd">Ctrl + V</span>.</p>
                        </div>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <p class="title-primer">Пример информации:</p>
                        <p>Местоположение врага, возможное количество нанесенного урона и т.д.</p>
                        <p>Если же поступает жалоба, что игрок никак не коммуницирует с командой - заходим в игровой войс и наблюдаем, для дальнейшей оценки. При наличии весомого отката - <span class="color-red">выдаем наказание</span>.</p>
                ...
                {
                    title: "1.7. Запрещена неявка после старта матча. Ожидание — 5 минут на подключение.",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
                        ...
                        <p>В подобном случае <span class="c-orange">наказание не выдаем</span>, все мы люди, а так же не забываем о частых проблемах с серверами.</p>`
                },
                {
                    ...
                    content: `
                        ...
                        <tr>
                            ...
                            <td class="notes-text">Бан <span class="penalty-1-8">2д</span></td>
                        </tr>
                        <tr>
                            <td class="number-rule">2</td>
                        ...
                        <table class="table-punishments-transitions">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><div class="punishment-item punishment-permanent">Бан <span  class="color-red">7д</span></div></td>
                                </tr>
                            </tbody>
                        </table>
                        <div>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <p> <span class="text-important">Нарушение</span> пункта - <span class="color-red">Перманентная блокировка</span> до момента основного разбана.</p>
        
                        <div style="margin-top: 20px;">
                            <span class="title title-info">Таблица 1.11</span>
                        </div></br>
                        <table class="rules-table-1-11">
                        <thead>
                            <tr>
                                <th>№</th>
                                <th>Правила сообщества Discord</th>
                            </tr>
                        </thead>
                        <tr>
                            <td class="number-rule">1</td>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <p>Примером может быть баг с анимацией плента бомбы, что позволяет смотреть сквозь текстуры.</p>`
                },
                {
                    ...
                    content: `
                        ...
                        <table class="table-punishments-transitions">
                            ...
                            <tbody>
                                <tr>
                                    <td><div class="punishment-item">Бан <span  class="penalty">2ч<span/></div></td>
                                    <td><div class="punishment-item punishment-repeat">Бан <span  class="penalty">30д<span/></div></td>
                                    <td><div class="punishment-item punishment-permanent">Бан <span  class="color-red">30д</span></div></td>
                                </tr>
                            </tbody>
                        </table>
                ...
                {
                    title: "3.1. Запрещено выдавать себя за клозмод сервера, если вы таковой не являетесь.",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
                        <table class="table-punishments-transitions">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><div class="punishment-item punishment-repeat">Бан <span  class="penalty">30д<span/></div></td>
                                    <td><div class="punishment-item punishment-permanent">Бан <span  class="color-red">90д</span></div></td>
                                </tr>
                            </tbody>
                        </table>
                        <div>
                ...
                {
                    title: "3.2. Запрещены насмешки прямым или косвенным образом, оскорбляющие клозмод сервера.",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
                ...
                {
                    title: "3.3. Запрещено несоблюдение прочих правил матча, указанных клозмодом сервера в частном порядке.",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
                        <table class="table-punishments-transitions">
                            ...
                            <tbody>
                                <tr>
                                    <td><div class="punishment-item">Бан <span  class="penalty">2ч<span/></div></td>
                                    <td><div class="punishment-item punishment-repeat">Бан <span  class="penalty">2ч<span/></div></td>
                                    <td><div class="punishment-item punishment-permanent"><span  class="color-red">*</span></div></td>
                                </tr>
                            </tbody>
                        </table>
                        <div>
                ...
                {
                    title: "3.4. Запрещено обманывать клозмод сервера (введение в заблуждение/дезинфо/фейк report и т.п.).",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
    ...
    document.querySelectorAll(".note button").forEach((button, index) => {
        button.addEventListener("click", () => {
            const notes = [
                ...
                {
                    title: "№3 Категория «Администрация» модерируются в личных сообщениях.",
                    content: `
                       <p><span class="color-blue">🛡️ Closemod</span> является частью персонала сервера и относится к представителям <span class="color-blue">Администрации</span>.</p>
                       <p>Все пункты правил категории <span class="color-blue">«Администрация»</span> модерируются через личные сообщения с представителями <span class="color-blue">Closemod</span>.</p>
                ...
                {
                    title: "Путеводитель по важным каналам для каждого представителя Closemod.",
                    content: `
                        <p class="title-primer">Важные каналы для вас:</p>
                            <details open class="my-details">
                                <summary>Closemod</summary>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <div>
                            ...
                            <p">Нарушение запретов ведет к наказанию начиная от <span class="color-vugovor">🔴 Выговор</span> и заканчивая <span class="color-red">баном</span> на сервере.</p>
                        ...
                        {
                            title: "Принцип взаимодействия с заявками в Whitelist",
                            content: `
        
                                <div>
                                    <p class="title-primer">Что такое Whitelist и зачем он нужен?:</p>
                                    <p><span class="bg-color-channels"> # 📝┇whitelist</span> — это механизм, который отсекает неподходящие аккаунты согласно установленным критериям.</br>Доступ имеется от роли <span class="bg-color-nastavnik">@• Наставник</span>.</p>
                                    
                                    <p class="title-primer">Актуальные ограничения:</p>
                                    <p class="tab-indent"><strong>1.</strong> Discord аккаунт создан более <b>30 дней</b>;</br><strong>2.</strong> От <b>1 часа</b> игры на <a class="links" href="http://cybershoke.net/">Cybershoke</a>.</p>
                                    <p>Пункт <span class="color-important">№2</span> условен для проверки общего числа часов в КС, если пользователь не играл на <a class="links" href="http://cybershoke.net/">Cybershoke</a>.</p>

                                    <p class="title-primer">Значительная часть поступающих заявок это:</p>
                                    <p class="tab-indent"><strong>1.</strong> Недавно созданный Discord;</br><strong>2.</strong> Аккаунт с пустой историей игр на <a class="links" href="http://cybershoke.net/">Cybershoke</a>.</p>

                                    <p><span class="color-yellow">№1 Проверка недавно созданных аккаунтов Discord:</span></br>Недавно созданные аккаунты могут принадлежать новым пользователям или пользователям, заблокированным на основном аккаунте, включая читеров. Перед одобрением заявки можно пригласить пользователя в голосовой канал для проверки, возможно, его голос окажется вам знакомым, и вы выявите твинк читера.</p>

                                    <p><span class="color-yellow">№2 Проверка аккаунтов с пустой историей игр на Cybershoke:</span></br>Сначала перейдите по ссылке из заявки на профиль пользователя Cybershoke. После перехода на Steam профиль визуально оцените аккаунт — обычно там есть оформление и значки. Проверьте общее количество часов в КС, скопируйте SteamID и зайдите на <a class="links" href="https://csgostats.gg/cs2">CSStats</a> для просмотра игровой информации:</p>
                                    <p class="tab-indent"><strong>1.</strong> <span class="grey-bg">K/D</span>;</br><strong>2.</strong> <span class="grey-bg">HS%</span>;</br><strong>3.</strong> <span class="grey-bg">WIN RATE</span>.</p>
                                    <p>Значения <span class="color-important">K/D выше 2</span> и <span class="color-important">HS от 80%</span> <b>могут указывать</b> на <span class="color-red">подозрительную игру</span>.</p>
                                    
                                    <div class="bg-notes-frame">
                                        Аккаунты созданные под фейсит, могут быть <span class="color-yellow">исключением</span>, так же стоит помнить, что все случаи индивидуальны и всегда бывают <span class="color-yellow">исключения</span>.
                                    </div>
                                

                                    <p><span class="color-red">ВАЖНО!</span></br>Заявки мы ни в коем случае <span class="color-red">НЕ УДАЛЯЕМ</span>. За это вы можете понести <span class="color-red">наказание</span>. Причиной этому является система, которая не позволяет отправлять удаленные заявки повторно.</p>
                        ...
                        {
                            title: "Правила бронирования мест в клозах",
                            content: `
                                <div>
                                    <p class="title-primer">Правила бронирования:</p>
                                    <p>Бронь может включать до <b>5 активных слотов</b> одновременно. Порядок брони зависит от порядка запроса на бронь, то есть кто первый запросил бронь - тот и первый в списке, далее по тому же принципу.</p>
                                    <p>При освобождении места, вы можете добавить нового человека в бронь, но только в <b>конец очереди</b>.</p>
                                    
                                    <p class="title-primer">Передача места в клозе:</p>
                                    <p>Пользователь может передать свой слот в броне/клозе другому игроку. Мы можем отказать, если игрок, который заменяет, уже провел слишком много игр: <b>3 игры подряд или 5 игр за последние 5 часов</b>.</p>

                                    <p class="title-primer">Приоритеты в клозах:</p>
                                    <p class="tab-indent"><strong>1.</strong> Игрок предыдущего мачта (не более 3 игр подряд);</br><strong>2.</strong> Игрок из первого слота брони;</br><strong>3.</strong> Рандомный игрок присоединившийся к записи, приоритет у того, кто в данный момент в войсе.</p>

                                    <p>Если игрок ушел после одного/двух матчей и пришел через одну игру с требованием  дать ему слот по праву того, что он уже играл - мы <span class="color-red">отказываем</span>. Пропуск хотя бы одной игры лишает его приоритета на слот.</p>

                                    
                                    <div class="bg-notes-frame">
                                        <span class="color-red">ВАЖНО!</span> Нарушение этих правил запрещено и влечет за собой последствия от <span class="color-beseda">🟡 Замечание</span> до <span class="color-vugovor">🔴 Выговор</span>.
                                    </div></br>
                        ...
                        {
                            title: "Правила создания дополнительных клозов",
                            content: `
                                <div>
                                    <p class="title-primer">Когда создавать новый клоз:</p>
                                    <p>В случае, если <b>5 и более</b> человек ждут открытия нового клоза.</p>
                                    <p> </p>

                                    <p class="title-primer">Предупреждение:</p>
                                    <p>Создание дополнительного клоза по просьбе менее 5 человек может привести к тому, что после завершения активного клоза игроки чужого клоза перейдут в ваш, что <strong>ЗАПРЕЩЕНО</strong>.</p>
                                    <p> </p>

                                    <p class="title-primer">Рекомендация:</p>
                                    <p>Предложите игрокам забронировать слот в уже имеющимся клозе. Если игроков <b>5 и более</b>, вы можете сделать попытку создания второго клоза, при условии, что все игроки из брони остаются при своих местах, если новый клоз не будет набран.</p>
                                    <p>Запись на второй клоз может быть активна только тогда, когда первый клоз уже стартовал (после старта ножевого).</p>

                                    <p class="title-primer">Неправильные ситуации:</p>
                                    <p>Если создано <b>1-2 клоза</b> и желающих играть менее 3 человек, перенаправьте их в активные клозы с возможностью брони. Если игроков <b>5 и более</b>, создайте новый клоз, но если он <b>не набирается</b>, удалите его и перенаправьте игроков в активные клозы.</p>
                                    <p>При создании <b>3 клозов</b> шансы собрать еще один крайне малы, за исключением приватных клозов.</p>

                                    <p class="title-primer">Общий вывод:</p>
                                    <p>Не создавайте дополнительные клозы без необходимости, так как это переманивает игроков из активных игр.</p>
                                    
                                    <div class="bg-notes-frame">
                                        <span class="color-red">ВАЖНО!</span> Нарушение данных правил влечет за собой внутренние наказания от <span class="color-beseda">🟡 Замечание</span> до <span class="color-vugovor">🔴 Выговор</span> с причиной «Игнорирование правил создания доп. клозов».
                                    </div></br>
                        ...
                        {
                            title: "Правила присутствия для зрителей в голосовых каналах команд",
                            content: `
                                <div>
                                    <p>Перекидывать друзей / прочих зрителей в игровые комнаты разрешено только по <b>согласию всех участников команды</b>, если же кто либо против - перекидывать <span class="color-red">запрещено</span>.</p>
                                    <p>Вы можете рекомендовать просмотр матча через подключение в режиме наблюдателя. Сделать это легко, в записи по кнопке в виде "Телевизора" - вы будете подключены в качестве зрителя. В целях безопасности данный способ имеет задержку.</p>
                                    <div class="bg-notes-frame">
                                        <span class="color-red">ВАЖНО!</span> За подобные нарушения вы будете получать внутренние наказания от <span class="color-beseda">🟡 Замечание</span> до <span class="color-vugovor">🔴 Выговор</span>.
                                    </div>
                                    <p>Если человек будучи зрителем создает помехи - вы вправе кикнуть его и запретить дальнейшее присутствие в игровых войсах в качестве зрителя.</p>
                                    <p>Ведущий клоза так же вправе запретить присутствие зрителей в игровых комнатах без объяснения на то причин, но только в <b>СВОЕМ КЛОЗЕ</b>.</p>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function openModal(modalElement, overlayElement) {
      ...
      body.classList.add("modal-open"); // Запрещаем скролл и добавляем размытие фона
  
      // Скрываем кнопку "Вверх"
      if (upButton) upButton.classList.remove("show");
    }
    ...
    function closeModal(modalElement, overlayElement) {
      ...
      body.classList.remove("modal-open"); // Включаем скролл и убираем размытие
  
      // Если прокрутка больше 75px, возвращаем кнопку "Вверх"
      if (upButton && window.scrollY > 75) {
    ...
    const searchOverlay = document.getElementById("custom-modal-overlay");
    const searchCloseButton = document.querySelector(".custom-close-button");
    const searchTrigger = document.getElementById("rules-search");
  
    if (searchTrigger) {
      searchTrigger.addEventListener("click", () => openModal(searchModal, searchOverlay));
    }
    if (searchCloseButton) {
      searchCloseButton.addEventListener("click", () => closeModal(searchModal, searchOverlay));
    }
  
    // **Модал правил (`rule-modal`)**
    const ruleModal = document.getElementById("rule-modal");
    const ruleOverlay = document.getElementById("modal-overlay");
    const ruleCloseButton = document.getElementById("close-modal");
  
    if (ruleCloseButton) {
      ruleCloseButton.addEventListener("click", () => closeModal(ruleModal, ruleOverlay));
    }
  
    // **Обработка кнопок "Подробнее" в правилах**
    document.querySelectorAll(".rule button").forEach(button => {
      button.addEventListener("click", () => {
        openModal(ruleModal, ruleOverlay);
      });
    });
  
    // **Обработка кнопок "Подробнее" в примечаниях**
    ...
    // **Обработка скролла для кнопки "Вверх"**
    ...
    document.querySelectorAll(".custom-modal-overlay, .modal-overlay").forEach(overlay => {
      overlay.addEventListener("click", () => {
        closeModal(ruleModal, ruleOverlay);
        closeModal(searchModal, searchOverlay);
      });
    });
  });
...
// Функция для смены темы и иконки
function changeTheme(theme) {
    const icon = document.getElementById('theme-icon');

    // Изменение иконки в зависимости от выбранной темы
    if (theme === 'light') {
        icon.src = 'img/icon-link-light.png'; // Иконка для светлой темы
        document.body.classList.remove('dark-theme', 'blue-theme');
        document.body.classList.add('light-theme');
        localStorage.setItem('theme', 'light'); // Сохраняем выбор в localStorage
        localStorage.setItem('icon', 'light-icon.png'); // Сохраняем иконку
    } else if (theme === 'dark') {
        icon.src = 'img/icon-link-dark.png'; // Иконка для темной темы
        ...
        localStorage.setItem('icon', 'dark-icon.png'); // Сохраняем иконку
    } else if (theme === 'blue') {
        icon.src = 'img/icon-link-blue.png'; // Иконка для синей темы
        document.body.classList.remove('light-theme', 'dark-theme');
        document.body.classList.add('blue-theme');
        localStorage.setItem('theme', 'blue'); // Сохраняем выбор в localStorage
        localStorage.setItem('icon', 'blue-icon.png'); // Сохраняем иконку
    }
}

// Восстановление темы и иконки из localStorage
function restoreTheme() {
    ...
    if (savedTheme) {
        ...
        // Если нет сохраненной темы, по умолчанию светлая тема
        changeTheme('light');
    }
}

// Обработчики для кнопок смены темы
...
document.getElementById('blue-theme').addEventListener('click', () => changeTheme('blue'));

// Восстановление темы при загрузке страницы
window.onload = restoreTheme;
