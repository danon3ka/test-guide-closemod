                ...
                },
                {
                    ...
                    content: `
...

                        {
                            ...
                            content: `
                                <div>
                                    ...
                                    <p><span class="color-red">ВАЖНО!</span></br>Нарушение этих правил запрещено и влечет за собой последствия от <span class="color-beseda">🟡 замечание</span> до <span class="color-vugovor">🔴 выговора</span>.</p>
                                </div>
...

                        {
                            ...
                            content: `
                                <div>
                                    ...
                                    <p>Подобные действия влекут за собой внутренние наказания: <span class="color-beseda">🟡 замечание</span>, <span class="color-pred">🟠 предупреждение</span> и т.д. по причине <span class="grey-bg">«Игнорирование правил создания доп. клозов»</span>.</p>
...

                        {
                            ...
                            content: `
                                <div>
                                    <p>Мы перекидываем зрителей / друзей и т.д. в игровые комнаты только по <b>согласию всех участников команды</b>, кто либо против - <span class="color-red">запрещено</span>.</p>
                                    <p>За подобные нарушения вы будете получать наказание от <span class="color-beseda">🟡 замечание</span> до <span class="color-vugovor">🔴 выговора</span>.</p>
                                    ...
                                    <p>Ведущий клоза так же вправе запретить присутствие зрителей в игровых комнатах <b>В СВОЕМ КЛОЗЕ</b> без объяснения на то причин.</p>
