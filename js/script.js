    ...
    document.querySelectorAll(".rule button").forEach((button, index) => {
        button.addEventListener("click", () => {
            const rules = [
                ...
                {
                    title: "1.10. Все замены игроков осуществляются исключительно ведущим мероприятия и не подлежат обжалованию.",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
                        <table class="table-punishments-transitions">
                            ...
                            <tbody>
                                <tr>
                                    <td><div class="punishment-item">Бан <span  class="penalty">15м<span/></div></td>
                                    <td><div class="punishment-item punishment-repeat">Бан <span  class="penalty">2ч<span/></div></td>
                        ...
                        <p>Решения ведущего по заменам окончательные и не подлежат обжалованию.</p>
                        <p class="tab-indent"><span class="c-red">Примеры как делать нельзя:</span></p>
                        <p class="tab-indent">Замена игрока из записи на вашего друга (без причины).</p>
                        <p class="tab-indent">Намеренный перерег по выдуманной причине, чтобы освободить слот для друга/друзей.</p>
                        <p class="tab-indent">Кик игроков после сыгранного клоза без их согласия. Читаем <span class="color-important">примечание из 1.12.</span></p>
                        <p"><span class="c-orange">Нарушение</span> данных примеров ведет к наказанию в виде <span class="color-pred">🟠 предупреждения</span> по причине <b>"Использование полномочий в личных целях."</b>.</p>

                        <div class="bg-notes-frame">
                            <span class="title-notes">Примечание:</span><br>Вы в праве кикнуть пользователя со своего клоза, при условии, что <b>большая часть</b> клоза не хочет играть с ним/продолжать с ним играть. Большинство в нашем случае это <b>от 5 человек</b>.
                        </div></br>
                        `
                },
                {
                ...
                {
                    title: "1.17. Запрещено использование неадекватных и провоцирующих ников в игре.",
                    content: `
                        <div>
                            <span class="title title-penalty">Наказание</span>
                        </div><br>
                ...
                },
                {
                    ...
                    content: `
                        ...
                        <p class="tab-indent">В данном случае <span class="c-orange">наказание не выдаем</span>.</p>
            `
                },
                /*
                Другие правила
